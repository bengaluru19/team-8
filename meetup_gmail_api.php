<?php
/*Client ID -> 182609821348-apqmdqn3553feppim9fsh06gmdvq7hrs.apps.googleusercontent.com
Client Secret -> JNTzUhWd--nSMHirAU6Zotxr
*/
?>
<!DOCTYPE html>
<html lang="en">
  <head>
    ...
    <meta name="google-signin-client_id" content="182609821348-apqmdqn3553feppim9fsh06gmdvq7hrs.apps.googleusercontent.com">
	    ...
	    <div class="container">
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav nav ml-auto">
	          ...
	          <li class="nav-item"><a href="#speakers-section" class="nav-link"><span>Sign In</span></a></li>
	          <li class="nav-item"><a href="#about-section" class="nav-link"><span>Sign Up</span></a></li>
	          ...
	          <div class="row d-md-flex no-gutters slider-text js-fullheight align-items-end justify-content-end" data-scrollax-parent="true">
		          ...
		          <div class="one-forth js-fullheight d-flex align-items-start align-items-md-center ftco-animate" data-scrollax=" properties: { translateY: '70%' }">
		          	<div class="text mt-4 mt-md-0">
			            ...
			            <h2 class="mb-4">“Volunteers do not necessarily have the time; <br>they just have the heart.”</h2>
    	...
    	<div class="container">
            ...
            <div style="width: 30%; margin: 25px auto;">
                    <form action="/" method="POST">
                        ...
                        <div class="form-group">
                        <input class="form-control" type="password" name="password" placeholder="Set Password(min length 5)"required pattern=".{5,}" >
                        </div>
                        <div class="form-group">
                        <input class="form-control" type="number" name="number" placeholder="Enter Phone No" required>
                        </div>
                        <div class="form-group">
                        <input class="form-control" type="text" name="org" placeholder="Enter Organization(Optional)">
                        </div>
                        <div class="form-group">
                        <input class="form-control" type="text" name="location" placeholder="Enter Address" required>
                        </div>
                        <div class="checkbox">
                        Interests: <br>
                        <label><input class="checkbox" type="checkbox" name="teach" value="teach">Teaching</label>
                        <label><input class="checkbox" type="checkbox" name="paint" value="paint">Painting</label>
                        </div>
                        Others (Please Specify)
                        <div class="form-group">
                        <input class="form-control" type="text" name="interests" placeholder="Other Interests">
                        </div>
                        <div class="form-group">
                        <input class="form-control" type="number" name="age" placeholder="Enter Your Age" min="18" required>
                        </div>
                        <div class="form-group">
		...
		<section class="ftco-section ftco-speakers" id="speakers-section">
			<div class="container">
    			...
    			<div id="landing-header">
          			...
          			<h1 class="fontclass" style="text-align: center">Login</h1>
    <form action="/login" method="POST">
        <div class="form-group">
            <input class="form-control" type="text" name="phno" placeholder="Contact No">
        </div>
        <div class="form-group">
